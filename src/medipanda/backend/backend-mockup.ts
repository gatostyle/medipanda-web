...
export const getEventBoardDetails: typeof originalGetEventBoardDetails = async (id: number) => {
...
export const getProductDetails: typeof originalGetProductDetails = async (id: number) => {
...
export const getSampleProvideReport: typeof originalGetSampleProvideReport = async (id: number) => {
...
export const getProductBriefingSingleReport: typeof originalGetProductBriefingSingleReport = async (id: number) => {
...
export const getProductBriefingMultiReport: typeof originalGetProductBriefingMultiReport = async (id: number) => {
