    ...
    () => [
      ...
      },
      {
        ...
        cell: () => {
          ...
          return <Chip label="일반" color="primary" variant="light" size="small" />;
        },
        size: 100
      },
      {
      ...
      },
      {
        ...
        accessorKey: 'title',
        cell: ({ getValue, row }) => (
          <Link to={`/admin/customer-center/notice/${row.original.id}`} style={{ textDecoration: 'none', color: 'primary.main' }}>
            {getValue() as string}
          </Link>
        )
      },
      ...
      {
        header: '노출범위',
        cell: () => <Chip label="전체" color="info" variant="light" size="small" />,
        size: 100
      },
      {
        header: '조회 수',
            ...
            <Grid container spacing={2} alignItems="center">
              ...
              <Grid item xs={12} sm={2}>
                <FormControl fullWidth size="small">
                  ...
                  <Select value={category} label="제약사명" onChange={(e) => setCategory(e.target.value)}>
                    <MenuItem value="전체">전체</MenuItem>
                    <MenuItem value="제약사1">제약사1</MenuItem>
                    <MenuItem value="제약사2">제약사2</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
              <Grid item xs={12} sm={2}>
          ...
          <Box sx={{ p: 2 }}>
            <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2}>
              ...
              <Stack direction="row" spacing={1}>
                ...
                <Button variant="outlined" size="small" component={Link} to="/admin/customer-center/notice/new">
                  등록하기
                </Button>
              </Stack>
            </Stack>
