...
import { FormControl, IconButton, InputAdornment, MenuItem, PaginationItem, Select, Stack, TextField, Typography } from '@mui/material';
...
export default function PrescriptionList() {
  ...
  return (
    <>
      ...
      <Stack direction='row' alignItems='flex-start' gap='24px' sx={{ marginTop: '40px' }}>
