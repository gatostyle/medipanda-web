...
const PendingStatus = styled(Typography)({
  fontSize: '14px',
  color: '#f44336',
  fontWeight: 500,
});
...
export default function RequestContractPending() {
  const contractInfo = {
    contractType: '법인',
    companyName: '케이엠메디슨',
    ...
    documents: [
      { label: '사업자등록증.pdf', filename: '사업자등록증.pdf' },
      { label: 'CSO 신고증.pdf', filename: 'CSO 신고증.pdf' },
      { label: '민예심사자료 교육이수증.pdf', filename: '민예심사자료 교육이수증.pdf' },
    ],
  };
      ...
      <StatusCard>
        <CardContent sx={{ p: 4 }}>
          ...
          <FormRow>
            ...
            <PendingStatus>계약서 검토중</PendingStatus>
          </FormRow>
        </CardContent>
      </StatusCard>
